...
const User = () => {
  ...
  return (
    ...
    <Link  to="/add" type="button" class="btn btn-primary">Add User  <i class="fa-solid fa-user"></i>+</Link>
            ...
            <tbody>
                ...
                {users.map((user,index)=>{
                    return(
                        ...
                        type="button" class="btn btn-danger">Delete <i class="fa-solid fa-trash"></i></button>
