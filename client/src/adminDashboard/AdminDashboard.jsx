      ...
      <main className="admin-dashboard-content">
        ...
        <div className="admin-quick-actions">
          ...
          <div className="admin-actions-grid">
            <Link to="/add" className="admin-action-btn">
        ...
        <div className="admin-dashboard-grid">
          ...
          <div className="admin-dashboard-card">
            ...
            <div className="admin-btn-group">
              <Link to="/add" className="admin-dashboard-btn">
                <div className="admin-btn-icon">
                  <i className="fas fa-user-plus" style={{ color: "#6366f1" }}></i>
                </div>
                <span>Add User</span>
              </Link>
              <Link to="/addstaff" className="admin-dashboard-btn">
                <div className="admin-btn-icon">
                  <i className="fas fa-user-tie" style={{ color: "#6366f1" }}></i>
                </div>
                <span>Add Staff</span>
              </Link>
              <Link to="/displaystaff" className="admin-dashboard-btn">
                <div className="admin-btn-icon">
                  <i className="fas fa-users-cog" style={{ color: "#6366f1" }}></i>
                </div>
                <span>Display Staff</span>
              </Link>
              <Link to="/userdashboardadmin" className="admin-dashboard-btn">
                <div className="admin-btn-icon">
          ...
          <div className="admin-dashboard-card">
            ...
            <div className="admin-btn-group">
              <Link to="/findash" className="admin-dashboard-btn">
                <div className="admin-btn-icon">
                  <i className="fas fa-chart-pie" style={{ color: "#f59e0b" }}></i>
                </div>
                <span>Financial Overview</span>
              </Link>
              <Link to="/financereport" className="admin-dashboard-btn">
                <div className="admin-btn-icon">
